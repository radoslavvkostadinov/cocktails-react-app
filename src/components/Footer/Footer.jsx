export default function Footer() {
    return (
        <footer className="bg-white w-full h-full bottom-0 mt-auto">
            <div className="max-w-7xl p-2 mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 mb-2 h-36">
                ...
                <div className="flex items-center justify-center">
                    <nav>
                        <div className="flex space-x-6 p-3">
                            <a href="#" aria-label="Twitter" className="text-gray-400 hover:text-indigo-950 transition-colors">
                                <svg
                            ...
                            <a href="#" aria-label="YouTube" className="text-gray-400 hover:text-indigo-950 transition-colors">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="24"
                                    height="24"
                            ...
                            <a href="#" aria-label="Facebook" className="text-gray-400 hover:text-indigo-950 transition-colors">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="24"
                                    height="24"
