    ...
    return (
        <footer className="bg-white w-full h-full bottom-0 mt-auto">
                ...
                <div className="flex items-center justify-center">
                    <nav>
                        <div className="flex space-x-6 p-3">
                            <a href="https://github.com/radoslavvkostadinov/cocktails-react-app" aria-label="Twitter" className="text-gray-400 hover:text-indigo-950 transition-colors">
                                <svg
                            ...
                            <a href="https://github.com/radoslavvkostadinov/cocktails-react-app" aria-label="YouTube" className="text-gray-400 hover:text-indigo-950 transition-colors">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="24"
                                    height="24"
                            ...
                            <a href="https://github.com/radoslavvkostadinov/cocktails-react-app" aria-label="Facebook" className="text-gray-400 hover:text-indigo-950 transition-colors">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="24"
                                    height="24"
            ...
            <div className="text-center text-sm text-gray-500 bg-orange-300 h-5 m-0 p-=0">
                © 2024 Tasty Sips. By Radoslav Kostadinov
            </div>
        </footer>
    )
}