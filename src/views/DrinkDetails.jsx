    ...
    return (
        <>
            ...
            <div className="mx-auto p-6 rounded-lg shadow-md flex flex-col md:flex-row justify-center">
                ...
                <div className="w-full md:w-1/2 md:pl-6 h-full bg-orange-gradient flex flex-col justify-around rounded-md items-center mr-24 xl:ml-48 lg:ml-48 md:ml-48 sm:mr-2 2xl:w-4/12 2xl:mr-52 xl:w-6/12 xs:flex xs:flex-col xs:justify-center xs:items-center">
                    <div className="w-full 2xl:w-11/12 2xl:mr-28 xl:ml-20 xl:mr-3 xs:flex xs:flex-col xs:justify-center xs:items-center md:mr-20">
                        ...
                        <ul className="ml-6 list-disc list-inside mb-4 2xl:mr-14 md:mr-2 lg:mr-5 xl:mr-44">
                    ...
                    <div className="sm:w-11/12 sm:mr-10 xs:ml-10 2xl:w-11/12 2xl:mb-4 mr-6 mb-2 md:mr-12 lg:mr-16">
                        ...
                        <div className="ml-6 mb-2 2xl:w-11/12 2xl:ml-9 bg-indigo-950 rounded-md text-lg text-white font-sans sm:w-92 sm:ml-6 md:w-72 xs:w-92 xs:ml-6 xs:w-72 lg:w-92 lg:ml-6 lg:w-72 xl:w-96 xl:mr-5 sm:w-full lg:w-full xl:ml-20">
