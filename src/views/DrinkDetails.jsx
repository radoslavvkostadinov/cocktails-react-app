...
export default function DrinkDetails() {
    ...
    return (
        <>
            ...
            <div className="mx-auto p-6 rounded-lg shadow-md flex flex-col items-center md:flex-row">
                ...
                <div className="md:w-1/2 md:pl-6 h-full bg-white-wall flex flex-col justify-around rounded-md items-center mr-24">
                    ...
                    <div className="w-full mr-6">
                        <h2 className="text-2xl text-indigo-950 ml-2 text-center mb-0 m-2">Instructions</h2>
